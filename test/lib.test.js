...
test('Return rut formatter', t => {
    t.is(rutTest.set('156491373'), '15.649.137-3');
});

test('Return rut formatter with `-`', t => {
    t.is(rutTest.set('15649137-3'), '15.649.137-3');
});

test('Return rut formatter with `-` & `.`', t => {
    t.is(rutTest.set('15.649.137-3'), '15.649.137-3');
});

test('Return rut formatter with `---` & `...`', t => {
    t.is(rutTest.set('1.5.6.4.9.1.3-7-3'), '15.649.137-3');
});
